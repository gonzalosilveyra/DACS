...
public enum ErrorEnum implements IEnumError {
    ...
    INVALID_PARAMETER(1007,"dacs.messages.error.invalid.parameter",HttpStatus.BAD_REQUEST),
    EXTERNAL_SERVICE_ERROR(1007,"dacs.messages.error.external.service",HttpStatus.BAD_REQUEST);
